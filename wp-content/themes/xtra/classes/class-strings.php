	...
	class Xtra_Strings {
		...
		public static function get( $string, $sprintf = '' ) {
			...
			$strings = [
				...
				'theme_name' 			=> apply_filters( 'xtra_config_theme_name', esc_html__( 'XTRA', 'xtra' ) ),
				...
				'based_on' 				=> esc_html__( 'Based on XTRA framework', 'xtra' ),
				'ref' 					=> apply_filters( 'xtra_config_buy_link', esc_html__( 'https://1.envato.market/xtratheme', 'xtra' ) ),
				'docs' 					=> esc_html__( 'https://xtratheme.com/docs', 'xtra' ),
				...
				'changelog' 			=> apply_filters( 'xtra_config_changelog_link', esc_html__( 'https://xtratheme.com/changelog', 'xtra' ) ),
				'change_log' 			=> esc_html__( 'Change Log', 'xtra' ),
				'ticksy' 				=> apply_filters( 'xtra_config_support_link', esc_html__( 'https://codevz.ticksy.com', 'xtra' ) ),
				'support' 				=> esc_html__( 'Support', 'xtra' ),
				'faqs' 					=> apply_filters( 'xtra_config_faq_link', esc_html__( 'https://xtratheme.com/faqs', 'xtra' ) ),
				...
				'plugins_pro' 			=> esc_html__( 'Plugins installation feature is available only when you %s activate your theme with a valid license code.', 'xtra' ),
				...
				'slider_placeholder' 	=> esc_html__( 'Please activate Slider Revolution Plugin then edit slider from Dashboard > Slider Revolution', 'xtra' ),
