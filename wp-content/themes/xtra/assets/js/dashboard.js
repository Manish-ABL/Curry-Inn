	...
	// Plugins installation.
		...
		var $this = $( this ),
			...
			pluginError = function( message ) {
				...
				$this.closest( '.xtra-plugin' ).append( '<div class="xtra-dashboard-error"><i class="dashicons dashicons-no-alt" aria-hidden="true"></i><span>' + message + '</span><a href="#" class="xtra-button-secondary xtra-error-close">' + xtraWizard.close + '</a></div>' );
